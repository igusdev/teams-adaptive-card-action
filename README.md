...
| `message`  | no       | `''`    | The message content. Supports Markdown. Will be omitted if left empty.                                                                                                                                                                             |
...
| `width`    | no       | `''`    | Container width. Accepts: `full`. Falls back to `default` if empty or unrecognized.                                                                                                                                                                |
